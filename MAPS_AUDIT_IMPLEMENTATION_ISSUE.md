...
Friend precise sharing and heatmap participation have separate semantics and must remain separate in both policy and implementation. Friend precise sharing is explicit and user-directed through audience selection plus pause or disable controls. Heatmap participation remains mandatory per requirement, but mandatory participation introduces legal and trust risk that must be managed with strict minimization, transparency, and enforceable safeguards.
