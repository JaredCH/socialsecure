  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl font-semibold mb-2">Feed</h2>
        <p className="text-gray-600">
          {isAuthenticated
            ? 'Create posts, view your timeline, and engage with likes and comments.'
      ...
      {isAuthenticated && (
        <form onSubmit={handleSubmitPost} className="bg-white rounded-lg shadow p-6 space-y-4">
      ...
      <section className="space-y-4">
        ...
        {loadingFeed ? (
          <div className="bg-white rounded-lg shadow p-6 text-gray-600">Loading feed...</div>
        ) : posts.length === 0 ? (
          ...
          posts.map((post) => {
            ...
            return (
              <article key={post._id} className="bg-white rounded-lg shadow p-5 space-y-3">
